source('output/excel-style-cache-20260914/common.R')
tables<-list(
...
cat('PASS: seven individual exports and one accumulated collection; all sheet/cell/package contents identical except created/modified timestamps.\n')
