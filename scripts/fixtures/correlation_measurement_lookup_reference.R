...
correlation_numeric_data <- function(data, variables, variable_info = NULL, category_table = NULL, prepared_vectors = NULL) {
...
correlation_normality_summary <- function(data, variables, variable_info = NULL, labels = character(0), category_table = NULL, prepared_vectors = NULL) {
  numeric_data <- correlation_numeric_data(data, variables, variable_info, category_table, prepared_vectors)
...
prepare_correlation_results <- function(
  ...
  normality_table <- if (isTRUE(normality_checked)) {
    correlation_normality_summary(data, variables, variable_info, labels, category_table, prepared_vectors)
  } else {
    data.frame()
  }
