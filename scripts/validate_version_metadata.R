...
assert_contains(release_readiness, "Confirm the Electron build has switched 0.9.x beta packaging names to final 1.0 release names", "release readiness beta package naming gate")
...
assert_contains(release_decision_log, "current 0.9.42 package metadata intentionally remains beta", "release decision log beta naming status")
