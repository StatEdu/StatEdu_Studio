...
assert_contains(readme, "The DOI and public homepage are not live yet", "README DOI public citation gate")
...
assert_contains(release_readiness, "DOI infrastructure is not built yet", "release readiness DOI status")
...
assert_contains(release_readiness, "README, `CITATION.cff`, and About do not publish a DOI citation line", "release readiness DOI metadata warning")
...
assert_contains(release_decision_log, "DOI/homepage infrastructure is not built yet", "release decision log DOI status")
assert_contains(release_decision_log, "no longer publish a DOI citation line", "release decision log DOI metadata warning")
