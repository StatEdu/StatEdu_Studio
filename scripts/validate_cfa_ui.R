...
stopifnot(
  ...
  grepl("isCfa ? cfaLatentX", toolbar_js_source, fixed = TRUE),
...
stopifnot(
  ...
  identical(cfa_option_tab_values, c("Estimation", "Bootstrap", "Advanced Options", "Validity", "Diagnostics", "Common Method")),
  identical(cfa_option_pane_values, c("Estimation", "Bootstrap", "Advanced Options", "Validity", "Diagnostics", "Common Method")),
