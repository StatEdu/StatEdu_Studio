...
stopifnot(
  ...
  grepl("function centerModelOnPaper(instance, renderedBounds)", canvas_js_source, fixed = TRUE),
  grepl("centerModelOnPaper(instance, bounds);", canvas_js_source, fixed = TRUE),
  ...
  grepl('instance.state.canvas.paperViewMode = "fit";', canvas_js_source, fixed = TRUE),
  ...
  grepl("function exportPng(instance, variant)", dialogs_js_source, fixed = TRUE),
  grepl("function exportSvg(instance, variant)", dialogs_js_source, fixed = TRUE),
