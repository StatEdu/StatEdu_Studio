...
stopifnot(
  ...
  grepl("B5 portrait", ui_source, fixed = TRUE),
  ...
  grepl('orientation: "portrait"', canvas_js_source, fixed = TRUE),
  grepl("widthPx: 688", canvas_js_source, fixed = TRUE),
  grepl("heightPx: 971", canvas_js_source, fixed = TRUE),
  ...
  grepl("top: 50%;", canvas_css_source, fixed = TRUE),
  grepl("margin-top: -9px;", canvas_css_source, fixed = TRUE),
  ...
  grepl("function svgFilePickerTypes()", dialogs_js_source, fixed = TRUE),
  grepl("types: svgFilePickerTypes()", dialogs_js_source, fixed = TRUE),
...
stopifnot(
  ...
  grepl("maxOffset || 310", edges_js_source, fixed = TRUE),
  grepl("latentCovarianceCurveOffset(otherLatent, latent)", toolbar_js_source, fixed = TRUE),
  grepl("latentCovarianceCurveOffset(otherLatent, latent, {minOffset: 70, maxOffset: 270, factor: 0.5})", toolbar_js_source, fixed = TRUE),
