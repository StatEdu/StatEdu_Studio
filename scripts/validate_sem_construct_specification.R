...
stopifnot(
  grepl('constructType: "commonFactor"', nodes_source, fixed = TRUE),
  grepl('measurementMode', nodes_source, fixed = TRUE),
  grepl('latent.constructType = "commonFactor";', canvas_source, fixed = TRUE),
  !grepl('"Not sure (show guidance)"', canvas_source, fixed = TRUE),
  grepl('"higherOrder", ko ?', canvas_source, fixed = TRUE),
  ...
  grepl('"weighting_not_implemented"', canvas_source, fixed = TRUE),
  grepl('advancedConstructSpecification', canvas_source, fixed = TRUE),
  grepl('"formative_mode_a"', canvas_source, fixed = TRUE),
  grepl('"reflective_mode_b"', canvas_source, fixed = TRUE),
