if (.Platform$OS.type == "windows" && !isTRUE(l10n_info()[["UTF-8"]])) {
  ...
  if (is.na(validation_locale) || !isTRUE(l10n_info()[["UTF-8"]])) {
    stop("SEM validation requires a Windows UTF-8 locale; Korean_Korea.utf8 could not be activated.")
  }
}

source(file.path("R", "utils.R"), encoding = "UTF-8")
source(file.path("R", "labels.R"), encoding = "UTF-8")
source(file.path("R", "setup_analysis_ui.R"), encoding = "UTF-8")
...
source(file.path("R", "setup_custom_model_canvas_structural_common_method.R"), encoding = "UTF-8")
...
source(file.path("R", "setup_custom_model_canvas_structural_higher_htmt.R"), encoding = "UTF-8")
...
source(file.path("R", "setup_custom_model_canvas_structural_pls_modmed_engine.R"), encoding = "UTF-8")
...
source(file.path("R", "setup_custom_model_canvas_structural_toolbar_icons.R"), encoding = "UTF-8")
...
source(file.path("R", "setup_custom_model_canvas_structural_render_htmt.R"), encoding = "UTF-8")
source(file.path("R", "setup_custom_model_canvas_structural_render_factor_scores.R"), encoding = "UTF-8")
source(file.path("R", "setup_custom_model_canvas_structural_render_reliability_bootstrap.R"), encoding = "UTF-8")
source(file.path("R", "setup_custom_model_canvas_structural_render_latent_correlations.R"), encoding = "UTF-8")
source(file.path("R", "setup_custom_model_canvas_structural_render_validity_notes.R"), encoding = "UTF-8")
...
source(file.path("R", "setup_custom_model_canvas_structural_render_moderation.R"), encoding = "UTF-8")
...
source(file.path("R", "setup_custom_model_canvas_structural_execute_notifications.R"), encoding = "UTF-8")
...
ui_source <- paste(
  c(
    ...
    readLines(file.path("R", "setup_custom_model_canvas_structural_toolbar_icons.R"), warn = FALSE, encoding = "UTF-8"),
    ...
    readLines(file.path("R", "setup_custom_model_canvas_structural_render_tables.R"), warn = FALSE, encoding = "UTF-8"),
    ...
    readLines(file.path("R", "setup_custom_model_canvas_structural_render_htmt.R"), warn = FALSE, encoding = "UTF-8"),
    readLines(file.path("R", "setup_custom_model_canvas_structural_render_factor_scores.R"), warn = FALSE, encoding = "UTF-8"),
    readLines(file.path("R", "setup_custom_model_canvas_structural_render_reliability_bootstrap.R"), warn = FALSE, encoding = "UTF-8"),
    readLines(file.path("R", "setup_custom_model_canvas_structural_render_latent_correlations.R"), warn = FALSE, encoding = "UTF-8"),
    readLines(file.path("R", "setup_custom_model_canvas_structural_render_validity_notes.R"), warn = FALSE, encoding = "UTF-8"),
    ...
    readLines(file.path("R", "setup_custom_model_canvas_structural_render_moderation.R"), warn = FALSE, encoding = "UTF-8"),
    ...
    readLines(file.path("R", "setup_custom_model_canvas_structural_execute_notifications.R"), warn = FALSE, encoding = "UTF-8"),
...
evaluation_source <- paste(c(
  ...
  readLines(file.path("R", "setup_custom_model_canvas_structural_model_comparison.R"), warn = FALSE, encoding = "UTF-8"),
  ...
  readLines(file.path("R", "setup_custom_model_canvas_structural_invariance_execute.R"), warn = FALSE, encoding = "UTF-8")
), collapse = "\n")
bootstrap_source <- paste(c(
  ...
  readLines(file.path("R", "setup_custom_model_canvas_structural_htmt_bootstrap_execute.R"), warn = FALSE, encoding = "UTF-8"),
  readLines(file.path("R", "setup_custom_model_canvas_structural_bollen_stine_bootstrap.R"), warn = FALSE, encoding = "UTF-8"),
  readLines(file.path("R", "setup_custom_model_canvas_structural_bollen_stine_bootstrap_execute.R"), warn = FALSE, encoding = "UTF-8")
), collapse = "\n")
...
source(file.path("R", "ui_helpers.R"), encoding = "UTF-8")
source(file.path("R", "analysis_commands.R"), encoding = "UTF-8")
source(file.path("R", "result_export_files.R"), encoding = "UTF-8")
source(file.path("R", "result_export.R"), encoding = "UTF-8")
