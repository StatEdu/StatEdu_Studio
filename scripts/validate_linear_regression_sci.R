...
# This validator checks the legacy English regression/SCI rendering. Appendix
# localization is exercised separately by validate_regression_screen_table_contract.R.
