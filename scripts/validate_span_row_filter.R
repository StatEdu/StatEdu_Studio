source('output/span-row-filter-20260914/common.R')
capture <- function(fn,table,row,column,columns) {
  conditions<-character()
  value<-withCallingHandlers(tryCatch(fn(table,row,column,columns),error=function(e)list(error=conditionMessage(e))),
