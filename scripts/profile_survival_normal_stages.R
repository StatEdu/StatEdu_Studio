...
root<-'output/survival-normal-stages-20260915';dir.create(root,recursive=TRUE,showWarnings=FALSE)
...
starts<-c(reason_counts='reason_counts',exclusion_mask='excluded',label_allocation='exclusion_labels',single_labels='single_reason',multiple_labels='multiple_reasons',audit_frame='row_audit',analysis_data='analysis_data',counts_issues='interest_events')
