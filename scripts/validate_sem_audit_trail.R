...
stopifnot(
  ...
  grepl('version = "1.8"', report_source, fixed = TRUE),
  ...
  grepl("latent_moderation_multiplicity", report_source, fixed = TRUE),
  grepl("multi_group_latent_moderation", report_source, fixed = TRUE),
  grepl("moderated_mediation_pairwise_differences", report_source, fixed = TRUE),
