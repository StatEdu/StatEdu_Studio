...
stopifnot(
  ...
  grepl('table$Model == "Metric", .030, .010', invariance_render_source, fixed = TRUE),
  grepl("table$DeltaCFI >= -.010", invariance_render_source, fixed = TRUE),
  grepl("table$DeltaRMSEA <= .015", invariance_render_source, fixed = TRUE),
  grepl("table$DeltaSRMR <= srmr_limit", invariance_render_source, fixed = TRUE),
  grepl("Δχ² is sample-size sensitive", invariance_render_source, fixed = TRUE)
)
...
stopifnot(
  ...
  grepl("structural_canvas_partial_invariance_status", invariance_render_source, fixed = TRUE)
)
