...
saved_results_inline_css <- function(max_width = 1280, print_landscape = FALSE) {
  paste(
    ...
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis.coefficient-table-mean-sd .coefficient-col-statistic { width: 132px !important; min-width: 132px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis:not(.coefficient-table-mean-sd) .coefficient-col-stat, .regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis:not(.coefficient-table-mean-sd) .coefficient-col-p, .regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis:not(.coefficient-table-mean-sd) .coefficient-col-effect-size { width: 42px !important; min-width: 42px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis:not(.coefficient-table-mean-sd) .coefficient-col-statistic { width: 136px !important; min-width: 136px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis.coefficient-table-mean-sd .coefficient-col-p, .regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis.coefficient-table-mean-sd .coefficient-col-effect-size { width: 42px !important; min-width: 42px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis.coefficient-table-mean-sd .coefficient-col-p-trend { width: 72px !important; min-width: 72px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis:not(.coefficient-table-mean-sd) .coefficient-col-p-trend { width: 84px !important; min-width: 84px !important; }",
    ...
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis .coefficient-col-posthoc { width: 66px !important; min-width: 66px !important; }",
