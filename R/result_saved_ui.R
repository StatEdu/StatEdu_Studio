...
saved_results_inline_css <- function(max_width = 1280, print_landscape = FALSE) {
  paste(
    ...
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df .coefficient-col-statistic { width: 112px !important; min-width: 112px !important; padding-right: 10px !important; text-align: right !important; white-space: nowrap !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df .coefficient-col-p { padding-left: 10px !important; }",
