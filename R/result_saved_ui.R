...
saved_results_inline_css <- function(max_width = 1280, print_landscape = FALSE) {
  paste(
    ...
    ".result-section.regression-result-panel:not(.landscape-table-panel):not(.paired-result-section):not(.logistic-diagnostics-panel) { width: min(100%, 780px); }",
    ...
    ".regression-results > .regression-result-panel:not(.landscape-table-panel):not(.model-overview-panel):not(.assumption-review-panel):not(.reference-summary-panel):not(.diagnostic-plots-section):not(.frequency-plots-section):not(.correlation-plot-section):not(.logistic-diagnostics-panel) { width: min(100%, 780px); max-width: 100%; overflow-x: hidden; box-sizing: border-box; }",
    ...
    ".coefficient-footnote-marker { display: inline-block; width: 0; margin-left: 1px; font-size: 10px; line-height: 0; position: static; text-align: left; vertical-align: super; }",
    ...
    "  .coefficient-footnote-marker { width: 0 !important; margin-left: 1px !important; font-size: 7.5pt !important; line-height: 0 !important; position: static !important; text-align: left !important; vertical-align: super !important; }",
