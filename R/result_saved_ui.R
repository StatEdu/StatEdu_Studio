...
saved_results_inline_css <- function(max_width = 1280, print_landscape = FALSE) {
  paste(
    ...
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df .coefficient-col-stat, .regression-results > .ttest-anova-result-panel .coefficient-table-show-df .coefficient-col-statistic { width: 88px !important; min-width: 88px !important; text-align: right !important; white-space: nowrap !important; }",
