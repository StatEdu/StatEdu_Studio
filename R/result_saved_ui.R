...
saved_results_inline_css <- function(max_width = 1280, print_landscape = FALSE) {
  paste(
    ...
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis .coefficient-col-term { width: 110px !important; min-width: 110px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis.coefficient-table-mean-sd .coefficient-col-value { width: 135px !important; min-width: 135px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis:not(.coefficient-table-mean-sd) .coefficient-col-value { width: 130px !important; min-width: 130px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis.coefficient-table-mean-sd .coefficient-col-mse { width: 128px !important; min-width: 128px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis.coefficient-table-mean-sd .coefficient-col-statistic { width: 158px !important; min-width: 158px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis:not(.coefficient-table-mean-sd) .coefficient-col-stat { width: 50px !important; min-width: 50px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis:not(.coefficient-table-mean-sd) .coefficient-col-p, .regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis:not(.coefficient-table-mean-sd) .coefficient-col-effect-size { width: 54px !important; min-width: 54px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis:not(.coefficient-table-mean-sd) .coefficient-col-statistic { width: 170px !important; min-width: 170px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis.coefficient-table-mean-sd .coefficient-col-p, .regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis.coefficient-table-mean-sd .coefficient-col-effect-size { width: 54px !important; min-width: 54px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis.coefficient-table-mean-sd .coefficient-col-p-trend { width: 94px !important; min-width: 94px !important; }",
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis:not(.coefficient-table-mean-sd) .coefficient-col-p-trend { width: 100px !important; min-width: 100px !important; }",
    ...
    ".regression-results > .ttest-anova-result-panel .coefficient-table-show-df.coefficient-table-trend-analysis .coefficient-col-posthoc { width: 76px !important; min-width: 76px !important; }",
    ...
    ".regression-results > .regression-result-panel .coefficient-table-bootstrap-regression { table-layout: fixed; }",
    ".regression-results > .regression-result-panel .coefficient-table-bootstrap-regression th, .regression-results > .regression-result-panel .coefficient-table-bootstrap-regression td { padding-left: 6px !important; padding-right: 6px !important; }",
    ".regression-results > .regression-result-panel .coefficient-table-bootstrap-regression .coefficient-col-term { width: 330px !important; min-width: 330px !important; }",
    ".regression-results > .regression-result-panel .coefficient-table-bootstrap-regression .coefficient-col-b { width: 56px !important; min-width: 56px !important; }",
    ".regression-results > .regression-result-panel .coefficient-table-bootstrap-regression .coefficient-col-boot-se { width: 78px !important; min-width: 78px !important; }",
    ".regression-results > .regression-result-panel .coefficient-table-bootstrap-regression .coefficient-col-ci { width: 68px !important; min-width: 68px !important; }",
    ".regression-results > .regression-result-panel .coefficient-table-bootstrap-regression .coefficient-col-boot-p { width: 72px !important; min-width: 72px !important; }",
    ".regression-results > .regression-result-panel .coefficient-table-bootstrap-regression .coefficient-col-compact { width: 48px !important; min-width: 48px !important; }",
    ".regression-results > .regression-result-panel .coefficient-table-bootstrap-regression .coefficient-col-tolerance { width: 92px !important; min-width: 92px !important; }",
    ".regression-results > .regression-result-panel .coefficient-table-bootstrap-regression .coefficient-col-vif { width: 60px !important; min-width: 60px !important; }",
