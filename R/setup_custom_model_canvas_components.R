...
custom_model_canvas_workspace <- function(
  ...
  tagList(
    analysis_canvas_sidebar(div(
      ...
      div(
        ...
        div(
          ...
          span(class = "custom-model-result-group-control",
            span(class = "custom-model-result-group-label", custom_model_canvas_text(language, "Group", "집단")),
    ...
    ), language, uiOutput("custom_model_canvas_save_control")),
