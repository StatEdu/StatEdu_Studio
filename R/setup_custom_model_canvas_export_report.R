...
structural_canvas_audit_manifest <- function(bundle, analysis_type = NULL, generated_at = Sys.time()) {
  ...
  list(
    ...
    resampling = list(
      ...
      structural_effects = list(replicates = bundle$effect_bootstrap %||% 0L, seed = bundle$effect_bootstrap_seed %||% NULL, interval = "case-resampling percentile for unstandardized and standardized effects", diagnostics = bundle$effect_bootstrap_result %||% NULL),
