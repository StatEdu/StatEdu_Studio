...
data_editor_merge_tab_panel <- function(language = statedu_initial_language()) {
  tabPanel(
    statedu_t("merge.ui.title", language),
...
data_editor_tab_panel <- function(language = statedu_initial_language()) {
  navbarMenu(
    ...
    lazy_tab_panel(analysis_scope_text(language, "케이스 선택", "Select cases"), "data_editor_cases", "lazy_data_editor_cases"),
    lazy_tab_panel(analysis_scope_text(language, "파일 분할", "Split file"), "data_editor_split", "lazy_data_editor_split"),
    ...
    lazy_tab_panel(statedu_t("merge.ui.title", language), "data_editor_merge", "lazy_data_editor_merge"),
