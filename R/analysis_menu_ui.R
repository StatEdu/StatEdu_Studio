...
analysis_tab_panel <- function(analysis_tabs = enabled_analysis_tabs(), language = statedu_initial_language()) {
  navbarMenu(
    ...
    if (isTRUE(analysis_tabs[["one_group_rm_anova"]])) lazy_tab_panel(statedu_ui_label("one_group_rm_anova", language), "One-group repeated-measures ANOVA", "lazy_analysis_one_group_rm_anova"),
    ...
    lazy_tab_panel(ipa_title(language), "IPA", "lazy_analysis_ipa"),
    ...
    if (isTRUE(analysis_tabs[["hierarchical"]])) lazy_tab_panel(penalized_menu_title("regularized",language), "analysis_penalized", "lazy_analysis_penalized"),
    ...
    if (isTRUE(analysis_tabs[["meta"]])) lazy_tab_panel(meta_ui_text("title", language), "analysis_meta", "lazy_analysis_meta")
  )
}
