...
app_stylesheet_link <- function(version) {
  tagList(
    ...
    tags$link(rel = "stylesheet", type = "text/css", href = paste0("model-canvas/canvas.css?v=", version, "-structural-equation-editor-tools-20260811t"))
  )
}
...
app_script_link <- function(version) {
  tagList(
    ...
    tags$script(src = paste0("model-canvas/state.js?v=", version, "-structural-equation-editor-tools-20260811t")),
    ...
    tags$script(src = paste0("model-canvas/edges.js?v=", version, "-structural-equation-editor-tools-20260811t")),
    tags$script(src = paste0("model-canvas/nodes.js?v=", version, "-structural-equation-editor-tools-20260811t")),
    tags$script(src = paste0("model-canvas/dialogs.js?v=", version, "-structural-equation-editor-tools-20260811t")),
    tags$script(src = paste0("model-canvas/toolbar.js?v=", version, "-structural-equation-editor-tools-20260811t")),
    tags$script(src = paste0("model-canvas/canvas.js?v=", version, "-structural-equation-editor-tools-20260811t"))
  )
}
