# easyflow_statistics 제품 계획

## 기본 방향

easyflow_statistics은 Windows 로컬 실행형 Shiny 앱으로 개발한다. 사용자는 R 또는 RStudio를 직접 열지 않고 `easyflow_statistics.bat`을 더블클릭하여 앱을 실행한다.
