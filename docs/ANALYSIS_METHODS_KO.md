...
### Continuous x Continuous 정규성 옵션

Normality diagnostics 옵션을 선택하면 continuous-continuous 조합에서 왜도/첨도 기준을 적용한다.

- 두 변수 모두 정규성 기준 만족: Pearson
- 하나 이상 정규성 기준 불만족: Spearman
...
- Normality table: continuous 변수만 왜도/첨도 평가, 비연속형 변수는 not assessed
