# Methodische Hinweise — StatEdu Studio 1.3.0

Erweiterung der ursprünglichen Methodennotizen: Schätzprinzipien, Annahmen, Formeln, Diagnostik und Interpretation.

## Inhalt

- [1. Messniveau](#method-1)
- [2. Deskriptivstatistik und Häufigkeiten](#method-2)
- [3. Kreuztabellen](#method-3)
- [4. t-Test und ANOVA](#method-4)
- [5. Nichtparametrische Tests](#method-5)
- [6. Gepaarte Daten und Messwiederholungen](#method-6)
- [7. Korrelation](#method-7)
- [8. Reliabilität und Übereinstimmung](#method-8)
- [9. Explorative Faktorenanalyse](#method-9)
- [10. Hauptkomponenten](#method-10)
- [11. Lineare Regression](#method-11)
- [12. Hierarchische Regression](#method-12)
- [13. Mediation und Moderation](#method-13)
- [14. Logistische Regression](#method-14)
- [15. Verallgemeinertes lineares Modell](#method-15)
- [16. Regularisierte Regression](#method-16)
- [17. Längsschnitt- und Panelmodelle](#method-17)
- [18. Komplexe Stichproben](#method-18)
- [19. Interpretation von Schwellenwerten](#method-19)
- [20. Warnungen und ausgelassene Ergebnisse](#method-20)
- [21. Interpretation gespeicherter Ergebnisse](#method-21)
- [22. Methodenbericht und Zitate](#method-22)
- [23. Literatur](#method-23)
- [24. Stichprobe, Teststärke und Effekt](#method-24)
- [25. CFA-, SEM- und PLS-SEM-Methoden](#method-25)
- [26. Zielgrößen der Überlebenszeitanalyse](#method-26)
- [27. Interpretation externer Validierung](#method-27)
- [28. Wichtigkeits–Leistungsanalyse (IPA)](#method-28)
