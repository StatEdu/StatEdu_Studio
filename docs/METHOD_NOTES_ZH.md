# 方法说明 — StatEdu Studio 1.3.0

在原有方法论笔记基础上扩展估计原理、假设、公式、诊断和解释。
...
- [2. 描述统计与频数](#method-2)
- [3. 交叉表](#method-3)
- [4. t 检验与 ANOVA](#method-4)
- [5. 非参数检验](#method-5)
- [6. 配对与重复测量](#method-6)
- [7. 相关](#method-7)
- [8. 信度与评定者一致性](#method-8)
- [9. 探索性因子分析](#method-9)
- [10. 主成分分析](#method-10)
- [11. 线性回归](#method-11)
- [12. 分层回归](#method-12)
- [13. 中介与调节效应](#method-13)
- [14. 逻辑回归](#method-14)
- [15. 广义线性模型](#method-15)
- [16. 正则化回归](#method-16)
- [17. 纵向与面板模型](#method-17)
- [18. 复杂抽样](#method-18)
- [19. 阈值的解释](#method-19)
- [20. 警告与跳过结果](#method-20)
- [21. 保存结果的解释](#method-21)
- [22. 方法报告与引用](#method-22)
- [23. 参考文献](#method-23)
- [24. 样本量、功效与效应量](#method-24)
- [25. CFA、SEM、PLS-SEM 方法](#method-25)
- [26. 生存分析的估计目标](#method-26)
- [27. 外部验证的解释](#method-27)
- [28. 重要性–表现分析（IPA）](#method-28)
