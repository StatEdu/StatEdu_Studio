# Notas metodológicas — StatEdu Studio 1.3.0

Ampliación de las notas originales: principios de estimación, supuestos, fórmulas, diagnóstico e interpretación.

## Índice

- [1. Nivel de medida](#method-1)
- [2. Descriptivos y frecuencias](#method-2)
- [3. Tablas cruzadas](#method-3)
- [4. Prueba t y ANOVA](#method-4)
- [5. Pruebas no paramétricas](#method-5)
- [6. Datos pareados y medidas repetidas](#method-6)
- [7. Correlación](#method-7)
- [8. Fiabilidad y concordancia](#method-8)
- [9. Análisis factorial exploratorio](#method-9)
- [10. Componentes principales](#method-10)
- [11. Regresión lineal](#method-11)
- [12. Regresión jerárquica](#method-12)
- [13. Mediación y moderación](#method-13)
- [14. Regresión logística](#method-14)
- [15. Modelo lineal generalizado](#method-15)
- [16. Regresión regularizada](#method-16)
- [17. Modelos longitudinales y de panel](#method-17)
- [18. Encuestas complejas](#method-18)
- [19. Interpretación de umbrales](#method-19)
- [20. Advertencias y resultados omitidos](#method-20)
- [21. Interpretación de resultados guardados](#method-21)
- [22. Informe y citas metodológicas](#method-22)
- [23. Referencias](#method-23)
- [24. Tamaño muestral, potencia y efecto](#method-24)
- [25. Métodos CFA, SEM y PLS-SEM](#method-25)
- [26. Estimandos de supervivencia](#method-26)
- [27. Interpretación de la validación externa](#method-27)
- [28. Análisis importancia–desempeño (IPA)](#method-28)
