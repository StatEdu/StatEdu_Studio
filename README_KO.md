...
버전 1.1.1은 로컬 데이터 불러오기, 데이터 편집, 가정 검토 기반 통계분석, 표본수/효과크기 계산기, HTML 결과 출력 기능을 제공하는 공개 릴리스 라인입니다. 버전 1.1.2-dev는 현재 개발자 소스 라인의 수정 및 UI 정리 버전입니다. 자세한 개발 이력은 **About > Version History**에서 확인할 수 있습니다.
