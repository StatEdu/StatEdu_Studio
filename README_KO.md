...
개발 소스 버전: **1.3.1-dev**. [개발 변경 내역](docs/RELEASE_1_3_1_DEV_20260920.md)을 참고하세요.
...
다음 공개 버전: `1.3.1` — 현재는 소스 준비 단계이며 설치본 제작·배포는 하지 않았습니다. [1.3.1 포함 범위](docs/RELEASE_1_3_1_PREPARATION_KO.md)를 참고하십시오. 메타분석과 동일개체 내 처치 반복측정 분산분석은 공개 메뉴에서 계속 제외합니다.
